...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:change="http://www.rbs.fr/change/1.0/schema" xml:lang="<?php echo $this->getLang(); ?>" lang="<?php echo $this->getLang(); ?>" class="no-js">
  <head>
